...
<div class="register-wrapper">
    <div class="image-side">
        <div class="image-content">
            <h1>Join the University Tutor Portal</h1>
            <p>Register with the same guided account flow used in the main tutor portal, while keeping the university support details this module needs.</p>
    ...
    <div class="form-side">
        <div class="form-box">
            ...
            <p class="intro">University & college tutor registration</p>
            ...
            <form id="step1Form" class="<?= $step !== 1 ? 'd-none' : '' ?>" method="post" action="<?= base_url('university-college-support/registerStep1') ?>">
                ...
                <div class="input-group">
                    ...
                    <label>Year of Study or Graduation</label>
                ...
                <div id="employerFields" style="<?= $workStatus === 'Employed' ? '' : 'display: none;' ?>">
                    <div class="input-group">
                ...
                <div class="input-group">
                    ...
                    <label>Short Competency Profile / Bio</label>
            ...
            <form id="step2Form" class="<?= $step !== 2 ? 'd-none' : '' ?>" method="post" action="<?= base_url('university-college-support/registerStep2') ?>">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" id="termsCheckbox" name="accept_terms" value="1" <?= old('accept_terms', '1') ? 'checked' : '' ?>>
                    <label class="form-check-label" for="termsCheckbox">
                        I confirm the information I provided is accurate and I agree to the portal terms.
                    </label>
