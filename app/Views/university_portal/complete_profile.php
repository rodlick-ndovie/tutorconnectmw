...
if ($fullName === '') {
    $fullName = (string) ($user['username'] ?? 'University Tutor');
}
    ...
    <div class="app-container">
        ...
        <div class="screen">
            ...
            >
                ...
                <p class="step-description">Complete your university professional profile in a few guided steps. Your submission helps the admin team verify your academic background, service areas, availability, rates, and supporting documents before approval.</p>

                <div class="prep-list">
                    <div class="prep-item">
                        <div class="prep-icon"><i class="fas fa-user-graduate"></i></div>
                        <div>
                            <div class="fw-semibold mb-1">Academic Profile</div>
                            <div class="text-muted small">Provide your study or graduation year, location, preferred teaching mode, work status, and a concise professional bio.</div>
                        </div>
                    </div>
                    ...
                    <div class="prep-item">
                        ...
                        <div>
                            <div class="fw-semibold mb-1">Institutions and Rates</div>
                            <div class="text-muted small">List the institutions you support and add the rates the team should consider for university-level assignments.</div>
                        </div>
                    </div>
                    ...
                    <div class="prep-item">
                        ...
                        <div>
                            ...
                            <div class="text-muted small">Upload a clear profile photo, national ID, and academic certifications or transcript for verification.</div>
                        </div>
                    </div>
                </div>
            ...
            <form id="profileWizardForm" method="post" action="<?= site_url('university-portal/complete-profile') ?>" enctype="multipart/form-data" novalidate>
                ...
                <section class="step-content wizard-step hidden" id="step1">
                    ...
                    <p class="step-description">Start with the core details the admin team uses to verify your university profile and place you correctly in the portal.</p>
                    ...
                    <div class="detail-grid">
                        <div class="field-group">
                            <label class="form-label" for="year_of_study_or_graduation">Year of Study or Graduation <span class="required">*</span></label>
                    ...
                    <div class="detail-grid hidden" id="employerFields" aria-hidden="<?= $workStatus === 'Employed' ? 'false' : 'true' ?>">
                        <div class="field-group">
                    ...
                    <div class="field-group">
                        <label class="form-label" for="bio">Short Competency Profile / Bio <span class="required">*</span></label>
                ...
                <section class="step-content wizard-step hidden" id="step2">
                    ...
                    <div class="field-group">
                        <label class="form-label" for="institutions">Institutions <span class="required">*</span></label>
                    ...
                    <div class="upload-grid">
                        <label class="upload-item<?= $profilePicturePath !== '' ? ' has-file' : '' ?>" id="profilePictureCard">
                            ...
                            <div class="upload-shell">
                                ...
                                <div class="w-100">
                                    <div class="upload-title">Profile Picture <span class="required">*</span></div>
                                    <div class="upload-hint" id="profilePictureHint">Upload a clear JPG or PNG profile image.</div>
                                    <div class="upload-preview" id="profilePicturePreview">
                                        <?php if ($profilePicturePath !== ''): ?>
                                            <a class="file-link" href="<?= base_url($profilePicturePath) ?>" target="_blank">Current profile picture on record</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <label class="upload-item<?= $nationalIdPath !== '' ? ' has-file' : '' ?>" id="nationalIdCard">
                            ...
                            <div class="upload-shell">
                                ...
                                <div class="w-100">
                                    <div class="upload-title">National ID <span class="required">*</span></div>
                                    <div class="upload-hint" id="nationalIdHint">Upload a scan or image file, or a PDF copy.</div>
                                    <div class="upload-preview" id="nationalIdPreview">
                                        <?php if ($nationalIdPath !== ''): ?>
                                            <a class="file-link" href="<?= base_url($nationalIdPath) ?>" target="_blank">Current national ID file on record</a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <label class="upload-item<?= $certificationFiles !== [] ? ' has-file' : '' ?>" id="certificationCard">
                            ...
                            <div class="upload-shell">
                                ...
                                <div class="w-100">
                                    <div class="upload-title">Academic Certifications / Transcript <span class="required">*</span></div>
                                    ...
                                    <div class="upload-preview" id="certificationPreview">
                                        <?php if ($certificationFiles !== []): ?>
                                            <?php foreach ($certificationFiles as $index => $filePath): ?>
                                                <a class="file-link" href="<?= base_url($filePath) ?>" target="_blank">Current certification file <?= $index + 1 ?></a>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                    </div>
                                </div>
                    ...
                    <div class="review-grid">
                        <div class="review-list">
                            ...
                            <div class="review-row">
                                ...
                                <div>
                                    <div class="review-label">Year of Study / Graduation</div>
                        ...
                        <div class="review-list full-span">
                            <h3 class="review-section-title"><i class="fas fa-building-columns"></i> Institutions</h3>
        ...
        function validateStep(stepNumber, silent = false) {
            ...
            if (stepNumber === 4) {
                ...
                if (!hasProfilePicture) {
                    return fail('Upload a profile picture before continuing.');
                }

                if (!hasNationalId) {
                    return fail('Upload the national ID file before continuing.');
                }

                if (totalCertifications === 0) {
                    return fail('Upload at least one academic certification or transcript.');
                }
