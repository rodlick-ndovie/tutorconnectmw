...
<head>
    <meta charset="utf-8">
    <title>Japan Applications Export</title>
    <style>
...
<div class="header">
    <div class="row">
        <div class="col">
            <p class="title">Japan Applications — Export</p>
            <p class="meta">
                Generated: <strong><?= esc(date('Y-m-d H:i:s')) ?></strong>
                <span class="muted">| Total: <?= esc((string) count($applications)) ?></span>
                <?php if ($statusFilter !== ''): ?><span class="muted">| Status: <?= esc($statusFilter) ?></span><?php endif; ?>
                <?php if ($searchQuery !== ''): ?><span class="muted">| Search: <?= esc($searchQuery) ?></span><?php endif; ?>
            </p>
            <p class="meta">
...
<table>
    ...
    <tbody>
        ...
        <?php foreach ($applications as $app): ?>
            <tr>
                <td><?= esc((string) $i) ?></td>
                <td><?= esc((string) ($app['application_reference'] ?? '')) ?></td>
                <td><?= esc((string) ($app['full_name'] ?? '')) ?></td>
                <td><?= esc((string) ($app['email'] ?? '')) ?></td>
                <td><?= esc((string) ($app['phone'] ?? '')) ?></td>
                <td><?= esc((string) ($app['nationality'] ?? '')) ?></td>
                <td><?= esc(ucwords(str_replace('_', ' ', (string) ($app['status'] ?? 'submitted')))) ?></td>
                <td><?= esc((string) ($app['submitted_at'] ?? '')) ?></td>
                <td><?= esc((string) ($app['degree_obtained'] ?? '')) ?></td>
            </tr>
            <?php $i++; ?>
        <?php endforeach; ?>
    </tbody>
