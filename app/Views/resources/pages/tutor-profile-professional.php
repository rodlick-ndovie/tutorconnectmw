        ...
        <div class="relative -mt-20 md:-mt-24 mb-8 z-10">
            <div class="flex flex-col md:flex-row md:items-end gap-6">
                ...
                <div class="flex-1 pb-4">
                    ...
                    <div class="mb-6">
                        <h1 class="text-3xl md:text-5xl font-extrabold bg-gradient-to-r from-primary via-red-500 to-red-600 bg-clip-text text-transparent leading-tight mb-3">
                            <?= esc(($tutor['user']['first_name'] ?? 'Unknown') . ' ' . ($tutor['user']['last_name'] ?? 'Tutor')) ?>
                        </h1>
                        <div class="flex flex-col md:flex-row md:items-center gap-1 md:gap-3">
                            <span class="text-base md:text-lg font-bold text-primary">Professional Tutor</span>
                            ...
                            <span>
                                <?php
                                    ...
                                    $modeDisplay = match(strtolower($teachingMode)) {
                                        ...
                                        'in-person', 'physical' => 'In-Person Tutoring',
                ...
                <div class="flex flex-col gap-2 md:pb-4">
                    ...
                    <!-- WhatsApp - Only show if plan allows it and tutor has WhatsApp -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-6">
                ...
                <div class="bg-white rounded-xl p-8 border border-gray-100 shadow-sm">
                    <p class="text-gray-700 leading-relaxed mb-6 text-base">
                        <?= nl2br(esc($tutor['bio'] ?? 'Professional tutor dedicated to student success. I specialize in personalized learning experiences tailored to each student\'s unique needs and learning style.')) ?>
                    </p>
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mt-1"><?= $tutor['experience_years'] ?? 0 ?> years of professional tutoring experience</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mt-1">Based in <?= esc($tutor['district'] ?? 'Malawi') ?>, available for tutoring sessions</p>
                        </div>
                    </div>
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 mt-1">
                                <?php if (!empty($tutor['is_employed']) && $tutor['is_employed'] == 1): ?>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    Self-employed tutor / Not currently employed at a school
                                <?php endif; ?>
                            </p>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <?php else: ?>
                    <div class="bg-white rounded-2xl shadow-lg p-12 border border-gray-100 text-center">
                        ...
                        <p class="text-gray-600 mb-6">Be the first to leave a review for this tutor!</p>
                        <button onclick="openReviewModal()" class="bg-gradient-to-r from-primary to-red-600 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center">
            ...
            <div class="flex flex-col justify-center text-white p-8 md:p-12">
                ...
                <p class="text-base md:text-lg text-red-100 mb-8 leading-relaxed">
                    Connect with <?= esc($tutor['user']['first_name'] ?? 'this tutor') ?> today and begin your learning journey. Achieve your academic goals with personalized, professional tutoring.
                </p>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-2xl max-w-2xl w-full max-h-screen overflow-y-auto">
            <div class="p-6 border-b border-gray-200">
                <div class="flex justify-between items-center">
                    <h3 class="text-xl font-bold text-gray-900">Rate & Review Tutor</h3>
            ...
            <div class="p-6">
                <form id="reviewForm" action="<?= base_url('home/submitReview') ?>" method="post" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="comment" rows="5" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary" placeholder="Share your experience with this tutor..."></textarea>
    ...
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="bg-white rounded-2xl max-w-lg w-full max-h-screen overflow-y-auto shadow-2xl">
            ...
            <div class="bg-gradient-to-r from-primary to-red-600 text-white p-6 rounded-t-2xl">
                <div class="flex justify-between items-center">
                    <div>
                        <h3 class="text-xl font-bold">Send Message to Tutor</h3>
            ...
            <div class="p-6">
                <form id="messageForm" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="subject" required class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all" placeholder="e.g., Math tutoring inquiry">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="5" required class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all resize-none" placeholder="Tell the tutor about your learning goals and availability..."></textarea>
                        <p class="text-xs text-gray-500 mt-2 flex items-center">
                            <i class="fas fa-info-circle text-primary mr-1"></i>
                            Your message will be sent directly to the tutor's email
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-2">How would you prefer the tutor to contact you?</p>
                    </div>
        ...
        <div class="bg-white rounded-2xl max-w-md w-full max-h-screen overflow-y-auto shadow-2xl">
            ...
            <div class="bg-gradient-to-r from-primary to-red-600 text-white p-6 rounded-t-2xl">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-red-100 text-sm mt-1">Help others discover this tutor</p>
                    </div>
            ...
            <div class="p-6">
                <div class="text-center mb-6">
                    ...
                    <h4 class="text-lg font-semibold text-gray-900">Share this tutor's profile</h4>
                    <p class="text-gray-600 text-sm">Help students find the perfect tutor</p>
                </div>
...
function shareToFacebook() {
    ...
    const title = encodeURIComponent("Check out this tutor on TutorConnect Malawi!");
    window.open(`https://www.facebook.com/sharer/sharer.php?u=${url}&quote=${title}`, '_blank', 'width=600,height=400');
}

function shareToTwitter() {
    const url = encodeURIComponent(window.location.href);
    const text = encodeURIComponent("Check out this amazing tutor on TutorConnect Malawi! 👨‍🏫📚");
    window.open(`https://twitter.com/intent/tweet?url=${url}&text=${text}`, '_blank', 'width=600,height=400');
}

function shareToWhatsApp() {
    const url = encodeURIComponent(window.location.href);
    const text = encodeURIComponent("Check out this tutor on TutorConnect Malawi: ");
    window.open(`https://wa.me/?text=${text}${url}`, '_blank', 'width=600,height=400');
}

function shareToLinkedIn() {
    const url = encodeURIComponent(window.location.href);
    const title = encodeURIComponent("Tutor Profile - TutorConnect Malawi");
    const summary = encodeURIComponent("Discover this qualified tutor on TutorConnect Malawi - your gateway to quality education!");
...
document.getElementById('messageForm')?.addEventListener('submit', function(e) {
    ...
    .then(data => {
        if (data.success) {
            showAjaxSuccess('Message sent successfully! The tutor will respond to your preferred contact method.');
            setTimeout(() => {
                closeMessageModal();
                // Reset form
