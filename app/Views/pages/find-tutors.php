...
<section class="bg-gradient-to-r from-primary to-orange-600 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 class="text-5xl md:text-6xl font-extrabold mb-4">Find Qualified Teachers</h1>
        <p class="text-xl text-red-100 max-w-3xl mx-auto">Search and filter verified Teachers across Malawi. Connect directly with the perfect tutor for your learning needs.</p>
    </div>
</section>
...
<div class="max-w-7xl mx-auto px-4 py-12">
        ...
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-slate-900">
                <?php if (!empty($tutors)): ?>
                    <?= count($tutors) ?> Teacher<?= count($tutors) != 1 ? 's' : '' ?> Found
                <?php else: ?>
                    No Teachers Found
                <?php endif; ?>
            </h2>
        ...
        <?php else: ?>
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-lg font-semibold text-slate-900 mb-2">No Teachers found</h3>
        ...
        <div class="bg-gradient-to-r from-primary to-orange-600 text-white flex items-center px-8 sm:px-12 lg:px-16 py-16">
            <div class="w-full">
                ...
                <p class="text-lg text-red-100 mb-8 leading-relaxed">
                    Join thousands of verified Teachers on TutorConnect Malawi. Grow your teaching business, connect with students.
                </p>
