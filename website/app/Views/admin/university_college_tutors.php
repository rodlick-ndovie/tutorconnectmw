...
$firmTutors = count(array_filter($allTutors, static fn(array $tutor): bool => ($tutor['account_type'] ?? 'individual') === 'firm'));
...
<div class="header-bar">
    <div>
        <h1 class="page-title">University Expert Management</h1>
        <p class="page-subtitle">Manage individual experts and firms registered through the university and college portal separately from the main tutor portal</p>
    </div>
...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-label">University Experts</div>
    </div>
    <div class="stat-card">
        <div class="stat-icon" style="background: linear-gradient(135deg, #10b981, #059669);">
            <i class="fas fa-building"></i>
        </div>
        <div class="stat-number"><?= number_format($firmTutors) ?></div>
...
<div class="content-card">
    <div style="display: flex; justify-content: space-between; align-items: center; gap: 16px; margin-bottom: 20px; flex-wrap: wrap;">
        <div>
            <h4 style="margin: 0 0 4px; color: var(--text-dark);">All University Experts</h4>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                <?php foreach ($tutors as $index => $tutor): ?>
                    ...
                    $accountType = ($tutor['account_type'] ?? 'individual') === 'firm' ? 'Firm' : 'Individual Expert';
                    ?>
                    <tr>
                        <td><?= $index + 1 ?></td>
                        <td>
                        ...
                        <td><span class="badge bg-info text-dark"><?= esc($accountType) ?></span></td>
