...
$title = $title ?? 'University Expert Details - TutorConnect Malawi';
$tutor = $tutor ?? [];
...
$identityDocumentMeta = $isFirm ? 'Firm verification document' : 'Identity verification document';
$certificationSectionLabel = $isFirm ? 'Business Evidence' : 'Academic Evidence';
$certificationFileLabel = $isFirm ? 'Business Certificate File' : 'Certification File';
$certificationFileMeta = $isFirm ? 'Business, registration, or professional proof' : 'Transcript, certificate, or academic proof';
$yearLabel = $isFirm ? 'Year Established / Registered' : 'Year of Study or Graduation';
$institutionsLabel = $isFirm ? 'Institutional / Business Background' : 'Academic Background';
$statusTone = [
    'approved' => 'success',
...
<div class="header-bar">
    <div>
        <h1 class="page-title"><?= $isFirm ? 'University Firm Review' : 'University Tutor Review' ?></h1>
...
<div class="row g-4">
    <div class="col-xl-8">
        <div class="row g-4">
            ...
            <div class="col-12">
                <div class="review-card wide-detail-card">
                    ...
                    <div class="detail-list">
                        ...
                        <div class="detail-row"><span class="detail-label">Account Type</span><span class="detail-value"><?= $isFirm ? 'Firm' : 'Individual Expert' ?></span></div>
            ...
            <div class="col-12">
                <div class="review-card wide-detail-card">
                    ...
                    <div class="detail-list">
                        ...
                        <div class="detail-row"><span class="detail-label"><?= esc($yearLabel) ?></span><span class="detail-value"><?= esc($tutor['year_of_study_or_graduation'] ?? '-') ?></span></div>
            ...
            <div class="col-12">
                <div class="review-card">
                    <h3 class="review-card-title"><i class="fas fa-building-columns"></i><?= esc($institutionsLabel) ?></h3>
                    <p style="margin:0 0 0.5rem;font-weight:600;"><?= $isFirm ? 'Background' : 'Institutions' ?></p>
        ...
        <?php else: ?>
            <div class="documents-grid">
                <?php if (!empty($tutor['profile_picture'])): ?>
                    <div class="document-card">
                        ...
                        <div class="document-card-header">
                            ...
                            <div>
                                <p class="document-title"><?= esc($profileImageLabel) ?></p>
                                <p class="document-meta">Public display image</p>
                            </div>
                        </div>
                        <img class="document-preview" src="<?= base_url($tutor['profile_picture']) ?>" alt="<?= esc(strtolower($profileImageLabel)) ?> preview" onerror="this.style.display='none';">
                ...
                <?php if (!empty($tutor['national_id_file'])): ?>
                    <div class="document-card">
                        ...
                        <div class="document-card-header">
                            ...
                            <div>
                                <p class="document-title"><?= esc($identityDocumentLabel) ?></p>
                                <p class="document-meta"><?= esc($identityDocumentMeta) ?></p>
                            </div>
                        </div>
                        <a class="doc-link" href="<?= base_url($tutor['national_id_file']) ?>" target="_blank" rel="noopener">
                            Open <?= esc($identityDocumentLabel) ?> <i class="fas fa-arrow-up-right-from-square"></i>
                        </a>
                    </div>
                <?php endif; ?>
                ...
                <?php foreach (($tutor['certification_files'] ?? []) as $index => $file): ?>
                    <div class="document-card">
                        <p class="document-section-title"><?= esc($certificationSectionLabel) ?></p>
                        <div class="document-card-header">
                            <span class="document-icon"><i class="fas fa-file-lines"></i></span>
                            <div>
                                <p class="document-title"><?= esc($certificationFileLabel) ?> <?= $index + 1 ?></p>
                                <p class="document-meta"><?= esc($certificationFileMeta) ?></p>
                            </div>
                        </div>
                        <a class="doc-link" href="<?= base_url($file) ?>" target="_blank" rel="noopener">
                            Open <?= esc($certificationFileLabel) ?> <?= $index + 1 ?> <i class="fas fa-arrow-up-right-from-square"></i>
                        </a>
                    </div>
                <?php endforeach; ?>
            </div>
