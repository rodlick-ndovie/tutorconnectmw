                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php foreach ($university_tutors as $uniTutor): ?>
                        <?php
                            ...
                            $isFirm = ($uniTutor['account_type'] ?? 'individual') === 'firm';
                        ...
                        ?>
                        <article class="h-full bg-white rounded-lg border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden flex flex-col">
                            ...
                            <div class="border-t border-slate-100 bg-slate-50/70 p-4">
                                <a href="<?= site_url('university-tutor/' . (int) ($uniTutor['id'] ?? 0)) ?>" class="inline-flex items-center justify-center w-full rounded-md bg-secondary text-white text-sm font-semibold px-4 py-2.5 hover:bg-primary transition">
