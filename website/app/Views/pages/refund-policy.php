...
<div class="max-w-4xl mx-auto px-4 py-12 md:py-16">
    ...
    <section class="mb-12">
        ...
        <p class="text-gray-700 leading-relaxed mb-4">
            At TutorConnect Malawi, we aim to ensure customer satisfaction with our teaching services. This Refund Policy outlines the conditions under which refunds may be issued and the process for requesting them.
        </p>
    ...
    <section class="mb-12">
        ...
        <ul class="space-y-3 text-gray-700">
            <li class="flex gap-3">
                ...
                <span><strong>Teaching Sessions:</strong> Paid sessions that were not completed or delivered</span>
            </li>
            <li class="flex gap-3">
                <span class="text-primary font-bold">•</span>
                <span><strong>Subscription Plans:</strong> Monthly or annual teaching subscriptions</span>
            </li>
            <li class="flex gap-3">
                <span class="text-primary font-bold">•</span>
    ...
    <section class="mb-12">
        ...
        <ul class="space-y-3 text-gray-700">
            <li class="flex gap-3">
                <span class="text-primary font-bold">•</span>
                <span>Sessions completed by the teachers (unless teacher quality issues are substantiated)</span>
            </li>
            <li class="flex gap-3">
                <span class="text-primary font-bold">•</span>
    ...
    <section class="mb-12">
        ...
        <div class="mb-8">
            ...
            <ul class="space-y-2 text-gray-700">
                <li class="flex gap-3">
                    <span class="text-primary font-bold">•</span>
                    <span>The teacher failed to appear for a scheduled session</span>
                </li>
                <li class="flex gap-3">
                    <span class="text-primary font-bold">•</span>
    ...
    <section class="mb-12">
        ...
        <ul class="space-y-3 text-gray-700">
            <li class="flex gap-3">
                <span class="text-primary font-bold">•</span>
                <span>Documented teacher misconduct or violations</span>
            </li>
            <li class="flex gap-3">
                <span class="text-primary font-bold">•</span>
