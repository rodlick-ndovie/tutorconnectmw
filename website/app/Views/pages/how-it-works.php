...
<section class="bg-gradient-to-r from-primary to-orange-600 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-red-100 max-w-3xl mx-auto">Simple steps to connect with qualified teacherss or start earning as a teacher</p>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">Find your perfect teacher in 3 simple steps - no registration required!</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Browse teachers</h3>
                <p class="text-gray-600">No registration needed! Browse verified teacherss by subject, curriculum, location, and reviews.</p>
            </div>
            ...
            <div class="text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3">Contact teacher</h3>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-4xl font-bold text-gray-900 mb-4">For Teachers</h2>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="rounded-2xl p-8 hover:shadow-lg transition-shadow">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-3 text-center">Verified teachers</h3>
                <p class="text-gray-600 text-center">All teachers are verified and qualified to ensure quality education.</p>
            </div>
            ...
            <div class="rounded-2xl p-8 hover:shadow-lg transition-shadow">
                ...
                <p class="text-gray-600 text-center">Connect with students and teachers across all of Malawi.</p>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch">
        ...
        <div class="bg-gradient-to-r from-primary to-orange-600 text-white flex items-center px-8 sm:px-12 lg:px-16 py-12">
            <div class="w-full">
                ...
                <p class="text-lg text-red-100 mb-8 leading-relaxed">Join thousands of students and teachers on TutorConnect Malawi.</p>
