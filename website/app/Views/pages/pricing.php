...
<section class="bg-gradient-to-r from-primary to-red-600 text-white py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-red-100 max-w-3xl mx-auto">Choose the perfect plan for your teaching business. Start earning today!</p>
    </div>
</section>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">Flexible subscription plans designed for teachers of all levels</p>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-0 items-stretch">
        ...
        <div class="bg-gradient-to-r from-primary to-red-600 text-white flex items-center px-8 sm:px-12 lg:px-16 py-12">
            <div class="w-full">
                ...
                <p class="text-lg text-red-100 mb-8 leading-relaxed">Join over 200 verified teachers already earning on TutorConnect Malawi.</p>
