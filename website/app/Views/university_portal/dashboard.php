...
$isFirmAccount = ($profile['account_type'] ?? 'individual') === 'firm';
$profileName = trim((string) ($profile['full_name'] ?? ''));
$displayName = $isFirmAccount ? $profileName : trim($firstName . ' ' . $lastName);
if ($displayName === '') {
    $displayName = $profileName !== '' ? $profileName : 'University Tutor';
}
$welcomeName = $isFirmAccount ? $displayName : ($firstName !== '' ? $firstName : $displayName);
...
<body>
    ...
    <div class="page">
        ...
        <section class="welcome-section">
            <h1 class="welcome-title">Welcome back, <?= esc($welcomeName) ?>.</h1>
